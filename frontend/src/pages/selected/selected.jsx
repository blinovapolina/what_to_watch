  ...
  useEffect(() => {
    const fetchFavorites = async () => {
      try {
        ...
        console.log("Избранные фильмы:", data);
        setFavorites(data);
      } catch (error) {
      ...
      <div className="selected">
        <Link to="/account" style={{ textDecoration: "none" }}>
          <div className="textMainSelected">
            <svg width="24" height="19" viewBox="0 0 24 19" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M19 9.49992H5M5 9.49992L12 15.0416M5 9.49992L12 3.95825"
                stroke="#9B9F9B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
            Главная
          </div>
        </Link>
        ...
        <div className="containerSelectedPage">
          <div className="containerScrollSelectedPage">
            {favorites.length === 0 ? (
                <div className="emptySelectedMessage">У вас пока нет избранных фильмов.</div>
            ) : (
              favorites.map((film) => (
                <div className="lineSelectedPage" key={film.id}>
                  <div className="leftLineSelectedPage">
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M5.50317 8.24878L11.0016 13.7499L16.5026 8.2515"
